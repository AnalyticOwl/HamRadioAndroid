...
function gotoPage(_pageName) {
      ...
      if (_pageName.indexOf(".html") > 0) {
            ...
            //$( ":mobile-pagecontainer" ).pagecontainer("change", _pageName, {  reverse: false });
            //$.mobile.pageContainer.pagecontainer("change", _pageName, { reverse: false, showLoadMsg: true });
